...
def create_recipe(user, **params):
    """Create and return the example recipe"""
...
class PrivateRecipeAPITests(TestCase):
    ...
    def test_create_recipe_with_new_ingredients(self):
        """Test creating the recipe with new ingredients"""
    ...
    def test_create_ingredients_on_update(self):
        """Test creating an ingeredient when updating a recipe"""
        recipe = create_recipe(user = self.user)
    ...
    def test_filter_by_tags(self):
        ...
        r2 = create_recipe(user=self.user, title='Kadai Paneer Masala')
    ...
    def test_filter_by_ingredients(self):
        ...
        r3 = create_recipe(user=self.user, title='Red Lintel Daal')
